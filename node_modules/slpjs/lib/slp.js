...
var Slp = /** @class */ (function () {
    ...
    Slp.prototype.buildNFT1GenesisOpReturn = function (config, type) {
    ...
    Slp.prototype.buildGenesisOpReturn = function (config, type) {
        if (type === void 0) { type = 0x01; }
        var hash;
        try {
